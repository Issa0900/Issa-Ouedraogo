...
> 📊 [Résultats d'analyse](./data/ANALYSE.md) · 🧹 [Rapport qualité](./data/RAPPORT-QUALITE.md) ·
> 📐 [Guide Power BI](./PowerBI/GUIDE-POWERBI.md) · 🗄️ [Schéma en étoile](./SQL/1_creation_schema.sql)
...
jamais eu à être corrigé. Le détail est dans [`data/RAPPORT-QUALITE.md`](./data/RAPPORT-QUALITE.md).
...
7 dimensions, 6 tables de faits, 1 table de qualité — [DDL complet](./SQL/1_creation_schema.sql).
...
**[49 mesures DAX](./PowerBI/mesures.dax)** commentées et vérifiées contre les requêtes SQL.

Trois points techniques que le [guide](./PowerBI/GUIDE-POWERBI.md) détaille, parce qu'ils
